...
with con:
	...
	def init():
		...
		measurement_shirt = "CREATE TABLE IF NOT EXISTS 'measurement_shirt' ('order_id' integer NOT NULL, 'length' int(11) DEFAULT NULL,'shoulder' int(11) DEFAULT NULL,'sleeve' int(11) DEFAULT NULL,'chest' int(11) DEFAULT NULL,'waist' int(11) DEFAULT NULL,'hip' int(11) DEFAULT NULL,'cross_front' int(11) DEFAULT NULL,'cross_back' int(11) DEFAULT NULL,'neck' int(11) DEFAULT NULL,'cuff' int(11) DEFAULT NULL,'half_sleeve' int(11) DEFAULT NULL,'arm_round' int(11) DEFAULT NULL, PRIMARY KEY(order_id), FOREIGN KEY ('order_id') REFERENCES 'order_details' ('order_id'))"
